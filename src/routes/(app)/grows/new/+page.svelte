<script lang="ts">
  ...
  let container = { containerType: "", containerPresetKey: null as string|null, containerConfig: {}, jarVariantId: null as number|null };
...
<section class="max-w-3xl mx-auto p-6 space-y-4">
  ...
  <input class="border p-2 w-full rounded" bind:value={form.batchCode} placeholder="e.g. MT-2025-10-01">
  ...
  <div class="flex gap-2 pt-2">
    <button class="px-4 py-2 rounded bg-emerald-600 text-white hover:bg-emerald-700" on:click|preventDefault={submit}>
      Create
    </button>
