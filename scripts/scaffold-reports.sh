...
base="src/routes/reports"
mkdir -p "$base"

# --- +page.server.ts ---
cat > "$base/+page.server.ts" <<'TS'
...
echo "[ok] Reports page scaffolded."
echo "Next:"
echo "  1) pnpm dev"
echo "  2) Visit /reports (optionally add ?locationId=1)"
echo "  3) When your Next Actions API is ready, this page will reflect it automatically."
